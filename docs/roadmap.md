...
| Chrome：Google Docs | Captured | **Known-bad**；公开示例文档人工拖选能产生 BoxSelect 候选，但 UIA 两次均返回 EmptySelection（默认模式 66ms；启用 Ctrl+Alt+Z 屏幕阅读器支持后 49ms） | Chrome 151.0.4129.93 |
